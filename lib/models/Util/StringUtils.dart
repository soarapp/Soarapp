...
//resourcepages
String resourcesBackground = 'assets/images/backgrounds/resourcesBackground.png';
List<String> information = ['Mental Health','Cancer and Oncology','Music Therapy'];
List<String> questions = ['What is music therapy?','What do music therapists do?','Who can benefit from music therapy?','Is there research to support music therapy?','What are some misconceptions about music therapy?','What\'s the most common type of music in music therapy?'];
List<String> answers = ['Music Therapy is the clinical and evidence based use of music interventions to accomplish individualized goals within a therapeutic relationship by a credentialed professional who has completed an approved music therapy program.','','','','','',''];
List<String> mentalHealthResources = ['American Institute for Cancer Research','National Institute of Mental Health','National Alliance on Mental Illness','National Council for Behavioral Health'];
List<String> mentalHealthResourcesDetails = ['The American Institute for Cancer Research promotes research and education on diet and cancer prevention. When you call or email the Nutrition Hotline, your question will be taken, and your call will be returned within three business days by a registered dietitian(RD).','','',''];
List<String> mentalHealthResourcesNumbers = ['800-843-8114','','',''];
List<String> mentalHealthResourcesLinks = ['https://www.aicr.org/','','',''];
List<String> cancerResources = ['American Institute for Cancer Research','Cancer Care','Cancer Hope Network'];
List<String> cancerResourcesDetails = ['The American Institute for Cancer Research promotes research and educationon diet and cancer prevention. When you call or email the Nutrition Hotline, your question will be taken, and your call will be returned within three business days by a registered dietitian(RD).','',''];
...
String questionIcon='assets/images/icons/questionIconGrey1.png';
