            ...
            children: [
              Expanded(
                ...
                child: Row(children: [
                  ...
                  Expanded(flex: 5, child: Image.asset('assets/images/spotifyLogo.png'),),
              ...
              Expanded(
                ...
                child:Row(
                  children: [
                    ...
                    Expanded(flex: 8, child: Text("Spotify Login", style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Comfortaa', fontSize: 35.0),),),
                  ],
                ),
              ),
              Expanded(
