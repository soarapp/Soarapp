              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: (blackQuestionButtonPressed == 1) ? 157 : 61,
                      child: Column(
                        children: [
                          Expanded(
                            flex: 1,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Expanded(
                                          flex:
                                              (blackQuestionButtonPressed == 1)
                                                  ? 3
                                                  : 0,
                                          child: (blackQuestionButtonPressed ==
                                                  1)
                                              ? Padding(
                                                  padding:
                    ...
                    Expanded(
                      flex: (whiteQuestionButtonPressed == 1) ? 157 : 61,
                      child: Column(
                        children: [
                          Expanded(
                            flex: 1,
                                        ...
                                        Expanded(
                                          flex:
                                              (whiteQuestionButtonPressed == 1)
                                                  ? 3
                                                  : 0,
                                          child: (whiteQuestionButtonPressed ==
                                                  1)
                                              ? Padding(
                                                  padding:
                                                      const EdgeInsets.all(6.0),
