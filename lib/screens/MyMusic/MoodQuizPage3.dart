    ...
    return BackgroundWithPopup(
      ...
      Column(
        ...
        children: [
          ...
          Expanded(
            flex: (blackQuestionButtonPressed == 1) ? 60 : 30,
            child: Column(
              children: [
                Expanded(
                  flex: 1,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Expanded(
                                flex: (blackQuestionButtonPressed == 1) ? 3 : 0,
                                child: (blackQuestionButtonPressed == 1)
                                    ? Padding(
          ...
          Expanded(
            flex: (whiteQuestionButtonPressed == 1) ? 60 : 30,
            child: Column(
              children: [
                Expanded(
                  flex: 1,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Expanded(
                                flex: (whiteQuestionButtonPressed == 1) ? 3 : 0,
                                child: (whiteQuestionButtonPressed == 1)
                                    ? Padding(
                                        padding: const EdgeInsets.all(6.0),
                                        child: Text(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: ReusableButton(
                        ...
                        buttonHeight:
                            MediaQuery.of(context).size.height * BUTTON_SCALER,
                        buttonText: "NEXT",
